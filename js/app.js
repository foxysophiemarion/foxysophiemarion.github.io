(() => {
    ...
    function initSliders() {
        if (document.querySelector(".swiper")) {
            new swiper_core_Swiper(".plane__slider", {
            ...
            new swiper_core_Swiper(".participants__slider", {
                ...
                pagination: {
                    el: ".slider-participants-pagination",
                    clickable: true,
                    type: "fraction"
                },
                navigation: {
                    prevEl: ".slider-participants-button-prev",
                    nextEl: ".slider-participants-button-next"
                },
                breakpoints: {
                    640: {
                        slidesPerView: 1,
    ...
    function runningLine() {
        const runningLineContainers = document.querySelectorAll(".running-line__contain");
        ...
        document.querySelectorAll(".running-line__contain").forEach((container => {
